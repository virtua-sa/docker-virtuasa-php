...
> [`virtuasa/php:7.4`](https://microbadger.com/images/virtuasa/php:7.4)
...
| [Tags (`virtuasa/php:`)](https://hub.docker.com/r/virtuasa/php/tags/)                             | 5.2      | 5.3       | 5.4      | 5.5      | 5.6      | 7.0       | 7.1       | 7.2       | 7.3       | 7.4       |
| ------------------------------------------------------------------------------------------------- | :------: | :-------: | :------: | :------: | :------: | :-------: | :-------: | :-------: | :-------: | :-------: |
| [PHP (`php`)](http://php.net/manual/en/)                                                          | *5.2.6*  | *5.3.3*   | *5.4.45* | *5.5.60* | *5.6.40* | *7.0.33*  | *7.1.33*  | *7.2.29*  | *7.3.16*  | *7.4.4*   |
...
| [PHP Coding Standards Fixer (`php-cs-fixer`)](https://github.com/friendsofphp/php-cs-fixer)       |          |           | *2.2.20* | *2.2.20* | *2.14.0+*| *2.14.0+* | *2.14.0+* | *2.14.0+* | *2.14.0+* | *2.14.0+* |
| [PHP Static Analysis Tool (`phpstan`)](https://github.com/phpstan/phpstan)                        |          |           |          |          |          |  *0.9.2*  | *0.10.3+* | *0.10.3+* | *0.10.3+* | *0.10.3+* |
...
| [Node.js (`node`, `npm`)](https://nodejs.org/dist/latest-v8.x/docs/api/)                          |          |           | *6.9.1*  | *6.9.1*  | *6.9.1*  | *8.9.0*   | *8.9.0*   | *8.9.0*   | *8.9.0*   | *8.9.0*   |
...
| [SSMTP](https://doc.ubuntu-fr.org/ssmtp)                                                          |  *2.64*  |  *2.64*   |  *2.64*  |  *2.64*  |  *2.64*  |  *2.64*   |  *2.64*   |  *2.64*   |  *2.64*   |  *2.64*   |
| [Debian](https://www.debian.org/doc/)                                                             | *lenny*  | *squeeze* | *wheezy* | *wheezy* | *jessie* | *stretch* | *stretch* | *stretch* | *buster*  | *buster* |
